...
include('../models/delete/deletecat.php');
if($_SESSION['msg']!="")
{
    $msg=$_SESSION['msg'];
}
                        ...
                        <div class="modal modal-signin position-static d-block  py-1" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body p-5 pt-0">
                                    <form class="row g-3 needs-validation" method="POST" action="../models/updat/modifcat.php?edit_category=<?=$tab['id']; ?>">
                                        <div class="form-floating mb-2">
                                            <input type="text" class="form-control rounded-4" id="floatingInput"
                                                        required name="categorie" value="<?=$tab['description']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="modal modal-signin position-static d-block  py-1" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body p-5 pt-0">
                                    <form class="row g-3 needs-validation" method="POST" action="../models/add/ajoutcat.php">
                                        <div class="form-floating mb-2">
                                            <input type="text" class="form-control rounded-4" id="floatingInput"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td><a href='categorie.php?edit_category=<?=$cat['id'] ?>' class='text-primary'><i class='bi-solid bi bi-pencil-square text-primary'></i></a></td>
                                <td><a href='categorie.php?delete_category=<?=$cat['id'] ?>'onclick="return confirm('Voulez-vous vraiment supprimer ?')"  type="button" 
                                class="text-primary">
