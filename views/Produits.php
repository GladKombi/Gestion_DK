  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="row">
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center">AJouter un nouveau stock</h4>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Configuration de la page</h5>
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">couleur de bouton</h6>
        </div>
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">choisir entre ces deux type</p>
        </div>
        <div class="d-flex">
